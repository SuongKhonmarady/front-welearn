      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-md p-8">
            <h1 className="text-3xl font-bold text-[#283d50] mb-8">Data Sources & Credits</h1>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">About Our Data Sources</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">🌟 Primary Data Sources</h2>
              <div className="space-y-6">
                <div className="border-2 border-blue-200 rounded-lg p-6 bg-blue-50">
                  <h3 className="text-xl font-semibold text-blue-800 mb-3">Opportunities Corners</h3>
                ...
                <div className="border-2 border-green-200 rounded-lg p-6 bg-green-50">
                  <h3 className="text-xl font-semibold text-green-800 mb-3">Scholarships Corner</h3>
            ...
            {/* Government Sources */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">🏛️ Government & Official Sources</h2>
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="text-lg font-semibold text-gray-800">U.S. Department of Education</h3>
                  <p className="text-gray-600">Federal student aid and scholarship information</p>
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="text-lg font-semibold text-gray-800">Fulbright Commission</h3>
                  <p className="text-gray-600">International exchange and scholarship programs</p>
                  <a href="https://fulbrightcommission.org" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
            ...
            {/* University Sources */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">🎓 University & Educational Institution Sources</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Major Universities</h3>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Educational Platforms</h3>
                  <ul className="text-gray-600 space-y-1">
            ...
            {/* Foundation Sources */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">🏢 Foundation & Organization Sources</h2>
              <div className="space-y-4">
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="text-lg font-semibold text-gray-800">Gates Foundation</h3>
                  <p className="text-gray-600">Educational opportunity and scholarship programs</p>
                </div>
                
                <div className="border-l-4 border-orange-500 pl-4">
                  <h3 className="text-lg font-semibold text-gray-800">Rhodes Trust</h3>
                  <p className="text-gray-600">Rhodes Scholarship and related programs</p>
                </div>
                
                <div className="border-l-4 border-red-500 pl-4">
                  <h3 className="text-lg font-semibold text-gray-800">Various Private Foundations</h3>
                  <p className="text-gray-600">Corporate scholarships, community foundations, and private donors</p>
                </div>
              </div>
            </section>            {/* Data Collection Notice */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">📊 Data Collection & Updates</h2>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-800 mb-3">How We Collect Data</h3>
              ...
              <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <h4 className="font-semibold text-yellow-800 mb-2">🔄 Update Frequency</h4>
            ...
            {/* Disclaimer */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">⚠️ Important Disclaimer</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#283d50] mb-4">📝 Copyright & Attribution</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="border border-blue-200 rounded-lg p-4">
                  <h4 className="font-semibold text-blue-800 mb-2">Opportunities Corners</h4>
                  <p className="text-sm text-gray-600 mb-2">We respect and acknowledge the original content and scholarship listings from opportunitiescorners.com</p>
                  <p className="text-xs text-blue-600">All rights remain with the original publisher</p>
                </div>
                
                <div className="border border-green-200 rounded-lg p-4">
                  <h4 className="font-semibold text-green-800 mb-2">Scholarships Corner</h4>
                  <p className="text-sm text-gray-600 mb-2">We respect and acknowledge the original content and scholarship listings from scholarshipscorner.website</p>
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-gray-700 mb-2"><strong>Contact for Data Issues:</strong></p>
                <p className="text-gray-700">Email: data@openscholarships.me</p>
                <p className="text-gray-700">Response Time: Within 48 hours</p>
                <p className="text-gray-700 text-sm mt-2">We will promptly address any concerns from original content publishers.</p>
              </div>
            </section>

            {/* Respect Notice */}
            <section className="bg-green-50 border border-green-200 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-green-800 mb-4">🙏 Our Commitment</h2>
